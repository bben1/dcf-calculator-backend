...
class Fundamentals:
    ...
    def get_interest_coverage_and_risk_free_rate(self):
        ...
        self.risk_free_rate = float(0.0013)
    ...
    def get_wacc(self):
        ...
        dp = self.bs[0]['totalDebt'] / (self.bs[0]['totalDebt'] + self.bs[0]['totalStockholdersEquity'])
        #capital structure equity proportion
        ep = self.bs[0]['totalStockholdersEquity'] / (self.bs[0]['totalDebt'] + self.bs[0]['totalStockholdersEquity'])
        #wacc calculation
    ...
    def f_score(self):
        ...
        results = {"f1Score":f1_score, 
                "f1Performance":"%.2f" % f1_performance,
                "profitabilityScore":profitability_score,
                "profitabilityPerformance":"%.2f" % profitability_performance,
                "leverageLiquidityScore":leverage_liquidity_score,
                "leverageLiquidityPerformance":"%.2f" % leverage_liquidity_performance,
                "operatingEfficiencyScore":operating_efficiency_score,
                "operatingEfficiencyPerformance":"%.2f" % operating_efficiency_performance
               }
